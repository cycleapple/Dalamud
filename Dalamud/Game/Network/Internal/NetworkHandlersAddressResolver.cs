...
internal class NetworkHandlersAddressResolver : BaseAddressResolver
{
    ...
    {
        // TW signature for CustomTalkEventResponsePacketHandler at 0x140a1e2c0
        this.CustomTalkEventResponsePacketHandler =
            scanner.ScanText(
                "48 89 5C 24 ?? 48 89 6C 24 ?? 48 89 74 24 ?? 57 48 83 EC ?? 49 8B D9 41 0F B6 F8 0F B7 F2 8B E9 E8 ?? ?? ?? ?? 48 8B C8 44 0F B6 CF 0F B6 44 24 ?? 44 0F B7 C6 88 44 24 ?? 8B D5 48 8B 44 24");
    }
}
